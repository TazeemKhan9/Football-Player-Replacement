...
def main():
	...
	if choice == 'Home':
		...
		st.write('After getting the clusters, we wanted to analyse the features of the clusters. We achieved this by taking average of all points in a clusters. This helped us distinguish between clusters and helped us to describe a cluster based on thier average stats.')
		pos_heat= st.selectbox("Select a Position",['Goalkeeper','Centre Back','Left Back','Right Back','Defensive Midfielder','Central Midfielder','Attacking Midfielder','Left Winger','Right Winger','Centre Forward'])
		if pos_heat=='Goalkeeper':
			heat1=pd.read_excel("https://github.com/TazeemKhan9/Football-Player-Replacement/blob/main/Data/Heatmap/Heatmap_GK_Saving.xlsx?raw=true")
			fig1 = go.Figure(data=go.Heatmap(z=heat1.iloc[:,1:], x=heat1.columns[1:], y=heat1.iloc[:,0],xgap=1, ygap=1, colorscale="Redor"),layout=go.Layout(title_text='Goalkeeper Saving',yaxis_autorange='reversed'))
		elif pos_heat=='Centre Back':
			heat1=pd.read_excel("https://github.com/TazeemKhan9/Football-Player-Replacement/blob/main/Data/Heatmap/Heatmap_CB_Defending.xlsx?raw=true")
			fig1 = go.Figure(data=go.Heatmap(z=heat1.iloc[:,1:], x=heat1.columns[1:], y=heat1.iloc[:,0],xgap=1, ygap=1, colorscale="Redor"),layout=go.Layout(title_text='Centreback Defending',yaxis_autorange='reversed'))
		elif pos_heat=='Left Back':
			heat1=pd.read_excel("https://github.com/TazeemKhan9/Football-Player-Replacement/blob/main/Data/Heatmap/Heatmap_LB_Defending.xlsx?raw=true")
			fig1 = go.Figure(data=go.Heatmap(z=heat1.iloc[:,1:], x=heat1.columns[1:], y=heat1.iloc[:,0],xgap=1, ygap=1, colorscale="Redor"),layout=go.Layout(title_text='Leftback Defending',yaxis_autorange='reversed'))
		elif pos_heat=='Right Back':
			heat1=pd.read_excel("https://github.com/TazeemKhan9/Football-Player-Replacement/blob/main/Data/Heatmap/Heatmap_RB_Defending.xlsx?raw=true")
			fig1 = go.Figure(data=go.Heatmap(z=heat1.iloc[:,1:], x=heat1.columns[1:], y=heat1.iloc[:,0],xgap=1, ygap=1, colorscale="Redor"),layout=go.Layout(title_text='Rightback Defending',yaxis_autorange='reversed'))
		elif pos_heat=='Defensive Midfielder':
			heat1=pd.read_excel("https://github.com/TazeemKhan9/Football-Player-Replacement/blob/main/Data/Heatmap/Heatmap_CDM_Defending.xlsx?raw=true")
			fig1 = go.Figure(data=go.Heatmap(z=heat1.iloc[:,1:], x=heat1.columns[1:], y=heat1.iloc[:,0],xgap=1, ygap=1, colorscale="Redor"),layout=go.Layout(title_text='CDM Defending',yaxis_autorange='reversed'))
		elif pos_heat=='Central Midfielder':
			heat1=pd.read_excel("https://github.com/TazeemKhan9/Football-Player-Replacement/blob/main/Data/Heatmap/Heatmap_CM_Passing.xlsx?raw=true")
			fig1 = go.Figure(data=go.Heatmap(z=heat1.iloc[:,1:], x=heat1.columns[1:], y=heat1.iloc[:,0],xgap=1, ygap=1, colorscale="Redor"),layout=go.Layout(title_text='CM Passing',yaxis_autorange='reversed'))
		elif pos_heat=='Attacking Midfielder':
			heat1=pd.read_excel("https://github.com/TazeemKhan9/Football-Player-Replacement/blob/main/Data/Heatmap/Heatmap_AM_Shooting.xlsx?raw=true")
			fig1 = go.Figure(data=go.Heatmap(z=heat1.iloc[:,1:], x=heat1.columns[1:], y=heat1.iloc[:,0],xgap=1, ygap=1, colorscale="Redor"),layout=go.Layout(title_text='AM Shooting',yaxis_autorange='reversed'))
		elif pos_heat=='Left Winger':
			heat1=pd.read_excel("https://github.com/TazeemKhan9/Football-Player-Replacement/blob/main/Data/Heatmap/Heatmap_LW_Shooting.xlsx?raw=true")
			fig1 = go.Figure(data=go.Heatmap(z=heat1.iloc[:,1:], x=heat1.columns[1:], y=heat1.iloc[:,0],xgap=1, ygap=1, colorscale="Redor"),layout=go.Layout(title_text='LW Shooting',yaxis_autorange='reversed'))
		elif pos_heat=='Right Winger':
			heat1=pd.read_excel("https://github.com/TazeemKhan9/Football-Player-Replacement/blob/main/Data/Heatmap/Heatmap_RW_Shooting.xlsx?raw=true")
			fig1 = go.Figure(data=go.Heatmap(z=heat1.iloc[:,1:], x=heat1.columns[1:], y=heat1.iloc[:,0],xgap=1, ygap=1, colorscale="Redor"),layout=go.Layout(title_text='RW Shooting',yaxis_autorange='reversed'))
		elif pos_heat=='Centre Forward':
			heat1=pd.read_excel("https://github.com/TazeemKhan9/Football-Player-Replacement/blob/main/Data/Heatmap/Heatmap_CF_Shooting.xlsx?raw=true")
			fig1 = go.Figure(data=go.Heatmap(z=heat1.iloc[:,1:], x=heat1.columns[1:], y=heat1.iloc[:,0],xgap=1, ygap=1, colorscale="Redor"),layout=go.Layout(title_text='CF Shooting',yaxis_autorange='reversed'))
		...
		val=num
		Age=st.number_input('Enter age',format=%i,step=1)
		if user_input=='GK':
